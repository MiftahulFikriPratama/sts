  ...
  return (
    <div className="relative bg-sky-50">
      ...
      <div className="flex items-center justify-center">
        <div className="w-4/5 pb-96 shadow-md  text-body text-lg font-semibold mt-10 pt-5 px-10 h-auto rounded-2xl bg-white ">
            ...
            <div className="pb-10 border-b-2 border-black">
              ...
              <div className="flex gap-10">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d247.79559991632658!2d106.7943402079398!3d-6.428774270154363!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69e9cd6f847eff%3A0x5782eb7a67a416e3!2sjasa%20desain%20grafis!5e0!3m2!1sid!2sid!4v1697387405405!5m2!1sid!2sid"
                  frameborder="0"
                ></iframe>
                <div className="w-1/3">
                  <h1 className="font-body">Alamat</h1>
                  <p className="font-body text-sm">
                    Jl. Pantai Parangkusumo, Pantai, Parangtritis, Kretek,
                    Bantul, Daerah Istimewa Yogyakarta, Indonesia, 55772
                  </p>
                </div>
              </div>
            </div>
          ...
          <h1
              ...
              <table className="mt-5 font-body text-base ">
                ...
                <tbody>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Tiket Masuk Pantai</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]" >Rp10.000</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Parkir Roda Dua</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp3.000</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Parkir Roda Empat</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp10.000</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Fasilitas Andong</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp30.000</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Fasilitas Sandboarding</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp70.000</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Penyewaan Motor ATV Kecil</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp50.000/30 Menit</td>
                  </tr>
                  <tr>
                    <td className="pl-3 py-2 border-y border-[#3c87ca]">Penyewaan Motor ATV Kecil</td>
                    <td className="pl-10 py-2 pr-3 border-y border-[#3c87ca]">Rp100.000/30 Menit</td>
                  </tr>
                </tbody>
              </table>
          </div>
